...
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS25 IOB TRUE} [get_ports ad40xx_spi_cs]        ; ## H07  FMC_LPC_LA02_P
...
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVCMOS25} [get_ports ad7944_cnv]                    ; ## G07  FMC_LPC_LA00_CC_N
